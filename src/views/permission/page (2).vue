            ...
            <div class="echarts-scatter">
                <div>
                    <el-row>
                        ...
                        <el-button plain type="success" @click="getScatterLately">最近7日</el-button>
                        <el-button plain type="success" @click="getScatterToday">今日</el-button>
                        <el-button plain type="success" @click="getScatterYesterday">昨日</el-button>
                    </el-row>
                </div>
             ...
             <div class="chart-container">
                 <div>
                    <el-row>
                        <label class="title">数据标题</label>
                      <el-date-picker v-model="dateValue" type="date" placeholder="选择日期" class="datePicker"></el-date-picker>
                      <el-button plain type="success" @click="getBarLately">最近7日</el-button>
                      <el-button plain type="success" @click="getBarToday">今日</el-button>
                      <el-button plain type="success" @click="getBarYesterday">昨日</el-button>
                    </el-row>
                </div>
