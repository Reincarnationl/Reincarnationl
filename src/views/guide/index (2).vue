<template>
  <div class="app-container">
    ...
    <div style="margin-top: 30px;">
      ...
      <el-row>
        <el-button type="success" plain @click="getTodayData">今天</el-button>
        <el-button type="success" plain @click="getYesterdayData">昨天</el-button>
        <el-button type="success" plain @click="getLastSevenDaysData">近七天</el-button>
        <el-date-picker v-model="value1" type="date" placeholder="选择日期" class="datePicker"></el-date-picker>
      </el-row>

<!--      <span style="margin-left: 20px;">-->
<!--        <el-date-picker v-model="value1" type="date" placeholder="选择日期" class="datePicker">-->
<!--        </el-date-picker>-->
<!--      </span>-->
    </div>
